...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('membership_type', models.CharField(verbose_name=(('M', 'Mensual'), ('T', 'Trimestral'), ('A', 'Anual')))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True)),
                ('gender', models.CharField(blank=True, choices=[('MAS', 'Masculino'), ('FEM', 'Femenino'), ('O', 'Otros')], max_length=3, null=True)),
